...
<!-- Ръководството по-долу прави предположението, че вече имате работеща среда, в която да изпълнявате примерите. Най-удобно за тази цел е да си направите регистрация в онлайн средата [AWS Cloud9](https://aws.amazon.com/cloud9/). Ако участвате в [Rails Girls Sofia събитие](http://railsgirls.com/sofia), то ще ви бъдат предоставени готови данни за вход в AWS Cloud9 и няма нужда да се регистрирате.
 -->
Ръководството по-долу прави предположението, че вече имате работеща среда, в която да изпълнявате примерите. Най-удобно за тази цел е да си направите регистрация в [Github](https://github.com/) и да си създадете нов [Codespace](https://github.com/codespaces), използвайки Blank Template.

<a name="tools"></a>

## Запознаване с инструментите

<!-- Преди да започнем да правим каквото и да е, трябва да се запознаем с инструментите, които ще използваме. В нашия случай, това са обикновен текстов редактор (например Notepad) и интегрираната онлайн среда за разработка [AWS Cloud9](https://aws.amazon.com/cloud9/). -->

Преди да започнем да правим каквото и да е, трябва да се запознаем с инструментите, които ще използваме. В нашия случай, това са обикновен текстов редактор (например Notepad) и интегрираната онлайн среда за разработка [Github Codespaces](https://github.com/codespaces).

<!-- Всеки майстор има нужда от определен набор инструменти и си има собствена работилница, в която твори. Вместо да ви караме да отделяте време, за да се снабдите с всички необходими инструменти и да си обзаведете собствена работилница специално за това събитие, ние ще ви дадем достъп до една готова такава, под наем – това е услугата [AWS Cloud9](https://aws.amazon.com/cloud9/). -->

Всеки майстор има нужда от определен набор инструменти и си има собствена работилница, в която твори. Вместо да ви караме да отделяте време, за да се снабдите с всички необходими инструменти и да си обзаведете собствена работилница специално за това събитие, ние ще използваме една готова такава – услугата [Github Codespaces](https://github.com/codespaces).

> **Инструктор:**
>
<!-- > Това е добър момент да влезете с участничките си в техния профил в [AWS Cloud9](https://aws.amazon.com/cloud9/). Организаторите на събитието би трябвало да са изпратили нужните данни за вход и за достъп до тяхната индивидуална работна среда. Съвети: -->

> Това е добър момент да влезете с участничките си в техния профил в [Github](https://github.com/) и да създадете нов [Codespace](https://github.com/codespaces), използвайки Blank Template, ако все още липсва такъв. Ползват се основно 3 неща от интерфейса – дървото с файлове в левия панел, текстовия редактор в центъра и Bash конзолата, която е в долния панел, под текстовия редактор. Средите "заспиват" автоматично след 30 минути неактивност. При повторно отваряне, с помощта на бутон се "събуждат".

<!-- > - Адресът за вход има следния вид: `https://РЕГИОН.console.aws.amazon.com/cloud9/ide/ИДЕНТИФИКАТОР`, например `https://eu-central-1.console.aws.amazon.com/cloud9/ide/095a1d92bc5b4738b997757a817aeed4` и е индивидуален за всеки участник.
> - При логин, преди да се въведе потребителско име и парола, се въвежда "AWS account ID or account alias", който е еднакъв за всички – `railsgirlssofia`.
> - Ползват се основно 3 неща от интерфейса – дървото с файлове в левия панел, текстовия редактор в центъра и Bash конзолата, която е в долния панел, под текстовия редактор.
> - Cloud9 средите "записват" автоматично след 20 до 30 минути неактивност. При повторно отваряне, се "събуждат" сами. Може да се наложи да се рефрешне екранът няколко пъти и да се изчака няколко минути да се събуди средата.
> -->
...
<!-- > Примерите по-долу могат да се тестват лесно в Cloud9, като се създаде и отвори за редакция един `something.html` файл там и от менюто "Preview" се избере "Preview File something.html". Това preview ще се отвори в панел в Cloud9. За да се отразят промените, които се правят по HTML файла, е най-лесно да стане с клавишната комбинация `Ctrl` + `Enter` (на Windows) или `Command` + `Enter` (на macOS). -->
...
>
> Друг вариант да показвате примерите по-долу, е с Notepad или Notepad2 на лаптопите на участничките, без да се занимавате с Github Codespaces. За целта, може да изтеглите [Notepad2](http://www.flos-freeware.ch/notepad2.html) ([директен линк, x86](http://www.flos-freeware.ch/zip/notepad2_4.2.25_x86.zip)), за да е цветен HTML-ът, който ще показвате тук. Notepad2 е добър вариант за Windows, тъй като е много лек и прост, прилича на вградения Notepad и няма излишни неща в интерфейса.
>
...
Интересен факт е, че името на Rails Girls събитията идва от друга Ruby библиотека за правене на уеб приложения, наречена _Ruby on Rails_. В първите издания на Rails Girls Sofia използвахме Ruby on Rails в това ръководство, но впоследствие преминахме на Sinatra, която е далеч по-проста и изчистена и е много по-добър вариант за навлизане в света не уеб програмирането.
...
![Github Codespaces Preview URL](/images/preview-url-github-codespace.png)
