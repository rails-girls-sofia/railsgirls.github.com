...
В долния десен ъгъл на екрана ще се появи прозорец, който съдържа URL адреса на вашето приложение. Ако кликнете върху линка, ще се отвори нов раздел в браузъра ви, в който трябва да пише "Здравей, гласоподавателю!".

![Cloud9 Preview URL](/images/preview-url.png)
